...
beforeAll(async () => {
    ...
    const doParse = parseHelper<Ontology>(services.Oml);
...
describe('Validating', () => {
    ...
    test('check capital letter validation', async () => {
        ...
        expect(
            ...
            // Check that our validation message for concept names is present
            expect.stringContaining('Concept name should start with a capital.')
        );
    });
});

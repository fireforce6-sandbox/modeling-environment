# Same as the kepler16b-example utilities.py but with the only change being
# the path of json.load in the dataframe function.
import json
import pandas as pd
...
def dataframe(fileName):
    data = json.load(open("../../build/results/modeling-environment/"+fileName))
